...
gene_list <- c('CD3D','IDO1','CIITA','CD3E','CCL5',
...
fit_cox <- coxph(Surv(times, status) ~ CD3D + IDO1 + CIITA + CD3E + CCL5 + GZMK + 
                   CD2 + `HLA-DRA` + CXCL13 + IL2RG + NKG7 + `HLA-E` + CXCR6 + 
                   LAG3 + TAGAP + CXCL10 + STAT1 + GZMB, data = train)
summary(fit_cox)
