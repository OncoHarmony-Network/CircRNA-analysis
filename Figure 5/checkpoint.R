...
gene_list <- c('BATF2', 'CTLA4', 'EGFR', 'HLA-DQB1', 'IKBKG', 'PIK3R2', 'PPP3CA')
...
fit_cox <- coxph(Surv(times, status) ~ BATF2 + CTLA4 + EGFR + `HLA-DQB1` + IKBKG + PIK3R2 + PPP3CA, data = train)
summary(fit_cox)
